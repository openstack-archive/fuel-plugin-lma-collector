...
#. Verify if the nodes are able to connect to the Elasticsearch server on port
   9200.

#. Verify if the nodes are able to connect to the InfluxDB server on port 8086.
