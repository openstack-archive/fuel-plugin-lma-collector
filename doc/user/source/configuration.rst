...
the 'collectd' and 'hekad' processes of LMA Collectors are running on the OpenStack nodes::
...
2. If one of LMA Collector is down, restart it::
...
3. Look for errors in the LMA Collector log file (located at /var/log/log_collector.log and /var/log/log_collector.log)
