...
* The GSE metric contains information about the health status
  ...
  nodes that have the same role. For exampe 'compute' or 'storage'.
...
2. The *node_cluster_roles* section defines the mapping between
   ...
   node(s) where Nagios is running.
...
This is the last aggregation stage that issues healt status
