...
* ``openstack_nova_services_percentage``, the percentage of Nova services in a
...
* ``openstack_cinder_services_percentage``, the percentage of Cinder services
...
* ``openstack_neutron_agents_percentage``, the percentage of Neutron agents by
