...
* ``openstack.nova.total_running_instances``, the total number of running instances on compute nodes.
* ``openstack.nova.total_running_tasks``, the total number of tasks currently executed by compute nodes.
