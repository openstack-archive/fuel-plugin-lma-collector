...
describe 'lma_collector::gse_cluster_filter' do
    ...
    describe 'with defaults' do
        ...
        it { is_expected.to contain_heka__filter__sandbox('gse_service').with_message_matcher("Type == 'heka.sandbox.afd_service_metric'") }
    end
    ...
    describe 'with dependencies' do
        ...
        it { is_expected.to contain_heka__filter__sandbox('gse_service').with_message_matcher("Type == 'heka.sandbox.afd_service_metric' || Type == 'heka.sandbox.afd_node_metric'") }
    end
end
