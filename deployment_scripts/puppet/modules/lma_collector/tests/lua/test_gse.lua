...
-- provision facts
gse.set_status("neutron", "neutron-api", consts.DOWN, {{message="All neutron endpoints are down"}}, 'node-1')
gse.set_status('keystone', 'keystone-admin-api', consts.OKAY, {}, 'node-1')
gse.set_status('glance', "glance-api", consts.WARN, {{message="glance-api endpoint is down on node-1"}}, 'node-1')
gse.set_status('glance', "glance-registry-api", consts.DOWN, {{message='glance-registry endpoints are down'}}, 'node-1')
gse.set_status("rabbitmq", 'rabbitmq-cluster', consts.WARN, {{message="1 RabbitMQ node out of 3 is down"}}, 'node-2')
gse.set_status("rabbitmq", 'rabbitmq-cluster', consts.OKAY, {}, 'node-1')
gse.set_status("rabbitmq", 'rabbitmq-cluster', consts.OKAY, {}, 'node-3')
gse.set_status('heat', "heat-api", consts.WARN, {{message='5xx errors detected'}}, 'node-1')
gse.set_status('nova', "nova-api", consts.OKAY, {}, 'node-1')
gse.set_status('nova', "nova-ec2_api", consts.OKAY, {}, 'node-1')
gse.set_status('nova', "nova-scheduler", consts.OKAY, {}, 'node-1')
