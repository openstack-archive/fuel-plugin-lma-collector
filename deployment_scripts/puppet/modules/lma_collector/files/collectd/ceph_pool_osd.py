...
class CephPoolPlugin(base.CephBase):
    ...
    def itermetrics(self):
        ...
        if not df:
            raise base.HeartbeatException("Fail to run 'ceph df'")
        ...
        if not stats:
            raise base.HeartbeatException("Fail to run 'ceph osd pool stats'")
        ...
        if not osd:
            raise base.HeartbeatException("Fail to run 'ceph osd dump'")
