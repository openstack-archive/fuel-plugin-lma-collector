...
METRIC_TYPES = {
    ...
    'pointsWrittenFail': ('points_written_fail', 'gauge'),
    ...
    'pointReqHH': ('point_request_hh', 'gauge'),
    'pointReqLocal': ('point_request_local', 'gauge'),
    'pointReqRemote': ('point_req_remote', 'gauge'),
    #'req': ('', 'gauge'),
    'subWriteDrop': ('sub_write_drop', 'gauge'),
    'subWriteOk': ('sub_write_ok', 'gauge'),
    'writeError': ('error', 'gauge'),
    'writeOk': ('ok', 'gauge'),
    'writeTimeout': ('timeout', 'gauge'),
    ...
    'NumGoroutine': ('unm_go_routine', 'gauge'),
