...
class GlanceStatsPlugin(openstack.CollectdPlugin):
    ...
    def read_callback(self):
        ...
        self.dispatch_value('images.size.active', total_img_size_gb)
        self.dispatch_value('images.size.other', total_img_err_size_gb)
        self.dispatch_value('snapshots.size.active', total_snap_size_gb)
        self.dispatch_value('snapshots.size.other', total_snap_err_size_gb)
