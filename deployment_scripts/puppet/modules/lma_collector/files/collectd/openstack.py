...
def retry_backoff(func):
    """A decorator to perform retries when an exception occurs.

    The BACKOFF_FACTOR is applied between retries to calculate sleep time.
