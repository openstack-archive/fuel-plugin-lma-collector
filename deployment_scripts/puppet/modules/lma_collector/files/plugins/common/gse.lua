...
-- inject a cluster metric into the Heka pipeline
-- the value is computed using the status of the subordinates
function inject_cluster_metric(cluster_name, name, interval, source)
