...
function process_message ()
    ...
    -- Get the program name, in the form "nova-api", dealing with the cases where
    -- logger is "nova-api" and where it's "nova-nova-api", the latter happening
    -- when the log file name starts with the service name.
    ...
    -- Change Logger to the form "openstack.nova"
