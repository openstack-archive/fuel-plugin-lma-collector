...
function process_message ()
    ...
    local hostname_free = {
        ...
        -- Add "metric_source = { list of metrics } to skip hostname for
        -- a subset of metric. The list of metrics is referenced through the
        -- field 'type_instance'.
        hypervisor_stats = {
            total_free_disk = true,
            total_free_ram = true,
            total_free_vcpus = true,
            total_running_instances = true,
            total_running_tasks = true,
            total_used_disk = true,
            total_used_ram = true,
