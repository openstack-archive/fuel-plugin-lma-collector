        ...
        for i, value in ipairs(sample['values']) do
            ...
            elseif metric_source == 'rabbitmq_info' then
                if sample['meta'] and sample['meta']['check_result'] then
                    msg['Fields']['name'] = 'rabbitmq' .. sep .. 'check'
            ...
            elseif metric_source == 'haproxy' then
                if sample['meta'] and sample['meta']['check_result'] then
                    msg['Fields']['name'] = 'haproxy' .. sep .. 'check'
                    msg['Fields']['details'] = sample['meta']['failure']
                else
            ...
            elseif metric_source == 'ceph_osd_perf' then
                if sample['meta'] and sample['meta']['check_result'] then
                    msg['Fields']['name'] = 'ceph_perf' .. sep .. 'check'
                    msg['Fields']['details'] = sample['meta']['failure']
                else
            ...
            elseif metric_source:match('^ceph') then
                if sample['meta'] and sample['meta']['check_result'] then
                    msg['Fields']['name'] = 'ceph' .. sep .. 'check'
                    msg['Fields']['details'] = sample['meta']['failure']
                else
            ...
            elseif metric_source == 'pacemaker_resource' then
                if sample['meta'] and sample['meta']['check_result'] then
                    msg['Fields']['name'] = 'pacemaker' .. sep .. 'check'
                    msg['Fields']['details'] = sample['meta']['failure']
                else
