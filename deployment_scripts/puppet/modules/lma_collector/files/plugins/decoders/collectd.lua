    ...
    for _, sample in ipairs(samples) do
        ...
        for i, value in ipairs(sample['values']) do
            ...
            elseif metric_source == 'interface' then
                ...
                msg['Fields']['name'] = 'net' .. sep .. sample['type_instance'] .. sep .. sample['type'] .. sep .. sample['dsnames'][i]
            ...
            elseif metric_source == 'glance' then
                msg['Fields']['name'] = 'openstack.glance' .. sep .. sample['plugin_instance'] .. sep .. sample['type_instance']
            else
