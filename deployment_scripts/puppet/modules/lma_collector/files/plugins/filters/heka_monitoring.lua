    ...
    for _, v in pairs(array) do
        if type(v) == "table" then
            ...
            if v.TimerEventAvgDuration then
                utils.add_to_bulk_metric('hekad_timer_avg_duration', v.TimerEventAvgDuration.value, tags)
            end
            if v.TimerEventSamples then
                utils.add_to_bulk_metric('hekad_timer_count', v.TimerEventSamples.value, tags)
            end
        end
    end
end
