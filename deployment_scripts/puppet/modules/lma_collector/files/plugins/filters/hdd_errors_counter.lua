...
-- [Question]
-- in this case (injected = false) first injecting of bulk metric will be
-- at the start of second interval (injecting in first interval will be skipped);
-- if initialize injected = true, then first injecting of bulk metric will be
-- at the start of first interval with small amount of values;
-- What way is better?
