...
-- bulk_size is the number of metrics embedded by a bulk_metric within the Payload
...
function process_message ()
    ...
    -- extra_time is used to palliate the time precision difference
    ...
    local extra_time = interval_in_ns / 2
    if timestamp < last_tick - extra_time then
