...
Declare this class to configure the filters that sends AFD metrics reporting the
availability of the OpenStack API endpoints.

#### Class: `lma_collector::afd::workers`

Declare this class to configure the filters that sends AFD metrics reporting the
availability of the Neutron agents and Cinder and Nova workers.
