...
define lma_collector::afd_nagios(
  ...
  heka::output::http { "nagios_afd_${title}":
    ...
    max_buffer_size   => $lma_collector::params::buffering_max_buffer_nagios_size,
    max_file_size     => $lma_collector::params::buffering_max_file_nagios_size,
    queue_full_action => $lma_collector::params::queue_full_action_nagios,
