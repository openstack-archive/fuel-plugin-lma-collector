...
class lma_collector::elasticsearch (
  ...
  heka::output::elasticsearch { 'elasticsearch':
    ...
    max_buffer_size   => $lma_collector::params::buffering_max_buffer_log_size,
    max_file_size     => $lma_collector::params::buffering_max_file_log_size,
    queue_full_action => $lma_collector::params::queue_full_action_log,
