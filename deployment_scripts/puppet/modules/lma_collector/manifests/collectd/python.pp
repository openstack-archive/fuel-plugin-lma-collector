...
define lma_collector::collectd::python (
  ...
  # We use the adapt_collectd_python_plugin_config to work around
  # a limitation in collectd::plugin::python::modulle where the
  # config hash cannot include values that are arrays or hashes.
