...
class lma_collector::influxdb (
  ...
  heka::output::http { 'influxdb':
    ...
    max_file_size     => $lma_collector::params::buffering_max_file_metric_size,
    max_buffer_size   => $lma_collector::params::buffering_max_buffer_metric_size,
    queue_full_action => $lma_collector::params::queue_full_action_metric,
