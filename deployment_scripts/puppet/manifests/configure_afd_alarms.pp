...
$lma = hiera_hash('lma', undef)
if $lma == undef {
    fail('hiera lma is undef. Check the configuration files in /etc/hiera/override.')
}
...
create_resources(lma_collector::afd::alarms, $cluster_alarms)
