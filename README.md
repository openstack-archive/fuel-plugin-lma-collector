...
OpenStack node that collects logs, notifications and metrics.

* logs and notifications are sent to an Elasticsearch server for diagnostic, troubleshooting
and alerting purposes.
* metrics are sent to an InfluxDB server for usage and performance analysis.
